...
public class AppsettingRowTitleValueBindingImpl extends AppsettingRowTitleValueBinding  {
    ...
    public AppsettingRowTitleValueBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private AppsettingRowTitleValueBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
