...
public class RakutenrewardUiTabfragmentMissionlistBindingImpl extends RakutenrewardUiTabfragmentMissionlistBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rakutenreward_tw_legal_text, 8);
        sViewsWithIds.put(R.id.rakutenreward_mission_list, 9);
    }
    // views
    @NonNull
    ...
    private RakutenrewardUiTabfragmentMissionlistBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 5
            ...
            , (com.rakuten.gap.ads.mission_ui.ui.common.RakutenTwLegalTextView) bindings[8]
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.rakutenrewardErrorMessage.setErrorText(getRoot().getResources().getString(R.string.rakutenreardsdk_tab_mission_error));
