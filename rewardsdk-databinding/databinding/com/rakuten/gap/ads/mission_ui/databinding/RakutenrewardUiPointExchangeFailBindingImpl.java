...
public class RakutenrewardUiPointExchangeFailBindingImpl extends RakutenrewardUiPointExchangeFailBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rakutenreward_pointexhange_error_title, 2);
        sViewsWithIds.put(R.id.rakutenreward_pointexhange_error_desc, 3);
    }
    // views
    @NonNull
    ...
    public RakutenrewardUiPointExchangeFailBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private RakutenrewardUiPointExchangeFailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
