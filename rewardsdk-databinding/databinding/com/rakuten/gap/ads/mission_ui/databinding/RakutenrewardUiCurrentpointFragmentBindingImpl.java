...
public class RakutenrewardUiCurrentpointFragmentBindingImpl extends RakutenrewardUiCurrentpointFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rakutenreward_point_layout, 6);
        sViewsWithIds.put(R.id.current_month_points_label, 7);
    }
    // views
    @NonNull
    ...
    protected void executeBindings() {
        ...
        int rakutenRewardConfigINSTANCERegionRakutenRewardRegionJPViewGONEViewVISIBLE = 0;
        ...
        java.lang.String portalViewModelGetUserNameContext = null;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xdL) != 0) {
                    ...
                    updateRegistration(0, portalViewModelTotalRakutenPoint);
            ...
            if ((dirtyFlags & 0xcL) != 0) {
                    ...
                    if (portalViewModel != null) {
                        ...
                        // read portalViewModel.getUserName(context)
                        portalViewModelGetUserNameContext = portalViewModel.getUserName(getRoot().getContext());
                    }
            }
            if ((dirtyFlags & 0xeL) != 0) {
                    ...
                    updateRegistration(1, portalViewModelRewardPoint);
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            if((dirtyFlags & 0x8L) != 0) {
                ...
                // read RakutenRewardConfig.INSTANCE.region == RakutenRewardRegion.JP ? View.GONE : View.VISIBLE
                rakutenRewardConfigINSTANCERegionRakutenRewardRegionJPViewGONEViewVISIBLE = ((rakutenRewardConfigINSTANCERegionRakutenRewardRegionJP) ? (android.view.View.GONE) : (android.view.View.VISIBLE));
        }
        // batch finished
        if ((dirtyFlags & 0xcL) != 0) {
            // api target 1
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.rakutenrewardUsername, portalViewModelGetUserNameContext);
        }
        if ((dirtyFlags & 0x8L) != 0) {
            // api target 1

            this.mboundView3.setVisibility(rakutenRewardConfigINSTANCERegionRakutenRewardRegionJPViewGONEViewVISIBLE);
        }
        if ((dirtyFlags & 0xeL) != 0) {
            // api target 1
    ...
    /* flag mapping
        flag 0 (0x1L): portalViewModel.totalRakutenPoint
        flag 1 (0x2L): portalViewModel.rewardPoint
        flag 2 (0x3L): portalViewModel
        flag 3 (0x4L): null
        flag 4 (0x5L): RakutenRewardConfig.INSTANCE.region == RakutenRewardRegion.JP ? View.GONE : View.VISIBLE
        flag 5 (0x6L): RakutenRewardConfig.INSTANCE.region == RakutenRewardRegion.JP ? View.GONE : View.VISIBLE
    flag mapping end*/
    //end
}